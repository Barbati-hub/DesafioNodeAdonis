  ...
  public async run() {
    try {
      ...
      await Produto.createMany([
        {
          ...
          preco: 8.90,
          quantidade: 50,
          imagem_url: 'https://images.unsplash.com/photo-1622483767028-3f908a1f3ca9?q=80&w=500&auto=format&fit=crop'
        },
        {
          nome: 'Batata Frita',
          ...
          preco: 15.90,
          quantidade: 30,
          imagem_url: 'https://images.unsplash.com/photo-1630389917978-9d9a91a873ad?q=80&w=500&auto=format&fit=crop'
        },
        {
          ...
          preco: 45.90,
          quantidade: 20,
          imagem_url: 'https://images.unsplash.com/photo-1604382355076-af4b0eb60143?q=80&w=500&auto=format&fit=crop'
        },
        {
          ...
          preco: 25.90,
          quantidade: 40,
          imagem_url: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=500&auto=format&fit=crop'
        }
      ])
      ...
      produtos.forEach(produto => {
        ...
        this.logger.info(`URL da Imagem: ${produto.imagem_url}`)
      })
    } catch (error) {
